...
namespace TestProject
{
    ...
    public class TypeFactoryTests
    {
        ...
        public void Write_DoesNotExceedCachingLimits()
        {
            ...
            int expectedTypeCount = Irvin.Extensions.Reflection.TypeFactory.NumberOfTypesCached;
            ...
            for (int j = 0; j < 100; j++)
            {
                ...
                Assert.AreEqual(expectedTypeCount, Irvin.Extensions.Reflection.TypeFactory.NumberOfTypesCached);
