...
namespace Company.Entities.MostExplicit
{
	...
	public class InterchangeControlLoop
	{
		...
		//this is more complex than it needs to be, I'm testing the framework
		[Field(Order = 2, IsFixedWidth = true, MaximumLength = 2, Alignment = FieldAlignment.Left, PaddingCharacter = '0')]  
